...
class TutorialCards extends Tool {  
  ...
  render() {
    return (
      <Container fluid className="tutorial-container p-0">
        ...
        <Container>
          <Row className="tutorial-card-container">
            <Col lg={3} xs={8} className="tutorial-card mt-5 mb-5" id="tutorial-card-1">
            ...
            <Col lg={3} xs={8} className="tutorial-card mt-5 mb-5" id="tutorial-card-2">
            ...
            <Col lg={3} xs={8} className="tutorial-card mt-5 mb-5" id="tutorial-card-3">
              <div className="tutorial-card-title">Breakdown</div>
              <div className="tutorial-card-text">After selecting a case, cooler, GPU and PSU a breakdown will be shown displaying a detailed spec. You can also scroll through other compatible parts.</div>
              <div className="icon-background">
